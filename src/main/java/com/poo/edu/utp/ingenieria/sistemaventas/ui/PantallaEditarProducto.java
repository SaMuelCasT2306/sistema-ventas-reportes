...
public class PantallaEditarProducto extends javax.swing.JFrame {
    ...
    public PantallaEditarProducto(Producto p) {
        this.producto = p;
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String precio = String.valueOf(producto.getPrecioUnitario()); 
    ...
    private void actualizarProducto(Producto p) throws SQLException{
        try {
            ...
            JOptionPane.showMessageDialog(this, "Producto actualizado con éxito", "Validación", JOptionPane.WARNING_MESSAGE);
